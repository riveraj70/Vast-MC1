...
var margin = {top: 0, right: 30, bottom: 60, left: 60},
...
d3.json("https://raw.githubusercontent.com/riveraj70/Vast-MC1/main/GateOrderNoDups", function( data) {
  // List of node names
  ...
  nodes
    .on('mouseover', function (d) {
	  // Set up Tooltip activation
	  div.transition()
		.duration(150)
		.style("opacity", 0.9);
	  div.html("Group: " + d.name.slice(0,-1) + "<br/>" + "#Trips: " + d.n)
      ...
      labels
        .style("font-size", function(label_d){ return label_d.name === d.name ? 16 : 6 } )
